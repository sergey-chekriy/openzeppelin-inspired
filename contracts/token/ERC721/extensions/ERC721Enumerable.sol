...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
     ...
     */
    function supportsInterface(bytes4 interfaceId) external view virtual override(IERC165, ERC721) returns (bool) {
    ...
    function _addTokenToAllTokensEnumeration(uint256 tokenId) private {
        _allTokensIndex[tokenId] = _allTokensLength;
        _allTokens[_allTokensLength] = tokenId;
        _allTokensLength++;
    }
    ...
    function _removeTokenFromAllTokensEnumeration(uint256 tokenId) private {
        ...
        uint256 lastTokenIndex = _allTokensLength - 1;
